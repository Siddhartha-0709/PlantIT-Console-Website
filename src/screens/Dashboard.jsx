                ...
                <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
                    <div className="flex flex-col justify-center px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
                        ...
                        <p className="mt-8 text-lg text-gray-700">
                            ...
                            <br />
                            This is your hub for managing your plant products and engaging with our community of plant enthusiasts. Get started by adding your plants to our marketplace, where they'll be showcased to eager buyers searching for their next green addition.
                        </p>
