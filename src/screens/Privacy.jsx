            ...
            <div className="mx-auto max-w-7xl px-4">
                ...
                <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
                    ...
                    <p className="mx-auto max-w-4xl text-center text-base text-gray-600 md:text-xl">
                        Ensuring the highest standards of data security and privacy,<br /> we are committed to providing you with a confident online experience. <br /> Our dedication to safeguarding your personal information ensures <br />your peace of mind while using our services.
                ...
                <div className="">
                    <div className="items-center justify-items-center">
                        ...
                        <div className="flex items-center justify-center">
                            <div className="">
                                <p className="text-2xl font-bold text-gray-900 md:text-4xl">Privacy Policy</p>
                                <p className="mt-4 text-xl font-bold  text-black">
                                    Safeguarding Your Data Security and Privacy Needs
                                </p>
                                <p className='text-lg'>
                                    Welcome to PlantIT, Our priority is to ensure the privacy and security of your personal information while providing you with a seamless experience using our platform. This Privacy Policy outlines how we collect, use, disclose, and protect your information in connection with our application, including its e-commerce features for selling and buying plants and plant products, as well as AI-based plant disease identification and prediction for gardening, and farming crops.
                                </p>
                                    <h3 className="mt-4 text-xl font-bold  text-black">Information We Collect:</h3>
                                    <li class="text-lg">Personal Information: When you register an account, make a purchase, or use our AI-based plant services, we may collect personal information such as your name, email address, shipping address, payment details, and any other information necessary to provide you with our services.</li>
                                    <li class="text-lg">AI Data: When you use our AI-based plant services, we may collect data related to plant images, disease identification results, and prediction outcomes to improve the accuracy and functionality of our AI algorithms.</li>
                                    <li class="text-lg">Usage Information: We may collect information about your interactions with our application, including browsing activity, search queries, and preferences.</li>
                           
                                    <h3 className="mt-4 text-xl font-bold  text-black">How We Use Your Information:</h3>
                                    <li class="text-lg">Provide Services: We use your information to facilitate transactions, deliver products, and provide AI-based plant services.</li>
                                    <li class="text-lg">Improve Services: We analyze usage data and AI data to improve our application's functionality, content, and user experience.</li>
                                    <li class="text-lg">Research and Development: We may use AI data for research and development purposes to enhance our AI algorithms and develop new features.</li>
                           
                                    <h3 className="mt-4 text-xl font-bold  text-black">Information Sharing:</h3>
                                    <li class="text-lg">Third-Party Service Providers: We may share your information with third-party service providers who assist us in operating our platform, processing transactions, and providing AI services.</li>
                                    <li class="text-lg">Legal Compliance: We may disclose your information in response to legal requests or to comply with applicable laws, regulations, or legal processes.</li>
                           
                           
                                    <h3 className="mt-4 text-xl font-bold  text-black">Data Security:</h3>
                                    <li class="text-lg">We implement reasonable security measures to protect your information from unauthorized access, disclosure, alteration, or destruction.</li>

                                    <h3 className="mt-4 text-xl font-bold  text-black">Children's Privacy:</h3>
                                    <li class="text-lg">Our services are not directed to children under the age of 13, and we do not knowingly collect personal information from children.</li>

                                    <h3 className="mt-4 text-xl font-bold  text-black">Updates to Privacy Policy:</h3>
                                    <li class="text-lg">We may update this Privacy Policy from time to time. Any changes will be posted on this page, and we encourage you to review the Privacy Policy periodically.</li>

                                    <p className='text-xl mt-5'>By using our application, you consent to the collection, use, and disclosure of your information as described in this Privacy Policy. Thank you for trusting us with your privacy.</p>
